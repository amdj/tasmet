...
namespace tube{
  ...
  // }
  vd Energy_full::error(const TubeVertex& v) const {		// Error in momentum equation
    TRACE(6,"Energy_full::Error(), i="<<v.i);
    assert(v.gc!=NULL);
    ...
    error+=v.eWddt*DDTfd*fDFT*(0.5*rhoti%Uti%Uti/pow(v.lg.vSf,2)); // This term should get a eWuddt factor later on
    // TRACE(100,"error:"<<error);
  ...
  dmat Energy_full::dpi(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dpi()");
    d T0=v.T(0);
    d gamma=this->gamma(v);
    dmat dpi=v.zero;
    const dmat& DDTfd=v.gc->DDTfd;
  ...
  dmat Energy_full::dpim1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dpim1()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    d gamma=this->gamma(v);
  ...
  dmat Energy_full::dpip1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dpip1()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    vd Uti=v.U.tdata();
  ...
  dmat Energy_full::dUi(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dUi()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    ...
    vd Uti=v.U.tdata();
    vd pti=v.p.tdata()+v.getp0t();
    dUi+=DDTfd*fDFT*diagmat(v.eWddt*rhoti%Uti/pow(v.lg.vSf,2))*iDFT; // This term should get a eWuddt factor later on
    dUi+=fDFT*diagmat(v.eWgi*gamfac*pti)*iDFT;
    dUi+=fDFT*diagmat(v.eWkini*3*0.5*rhoti%pow(Uti,2))*iDFT;

    return dUi;
  }
  dmat Energy_full::drhoi(const TubeVertex& v) const {
    TRACE(0,"Energy_full::drhoi()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    ...
    vd Uti=v.U.tdata();
    drhoi+=DDTfd*fDFT*diagmat(0.5*v.eWddt*pow(Uti,2)/pow(v.lg.vSf,2))*iDFT; // This term should get a eWuddt factor later on
    drhoi+=fDFT*diagmat(v.eWkini*0.5*pow(Uti,3))*iDFT;

    return drhoi;
  }  
  dmat Energy_full::dUim1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dUim1()");
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    d gamma=this->gamma(v);
    d gamfac=gamma/(gamma-1.0);
  ...
  dmat Energy_full::dUip1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dUip1()");
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    d gamma=this->gamma(v);
    d gamfac=gamma/(gamma-1.0);
  ...
  dmat Energy_full::drhoim1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::drhoim1()");
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    d gamma=this->gamma(v);
    d gamfac=gamma/(gamma-1.0);
  ...
  dmat Energy_full::drhoip1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::drhoip1()");
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    d gamma=this->gamma(v);
    d gamfac=gamma/(gamma-1.0);
  ...
  dmat Energy_full::dpip2(const TubeVertex& v) const {
    dmat dpip2=v.zero;
    #ifdef EN_VISCOSITY
  ...
  dmat Energy_full::dpim2(const TubeVertex& v) const {
    dmat dpim2=v.zero;
    #ifdef EN_VISCOSITY
  ...
  dmat Energy_full::dTip1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dTip1()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
  ...
  dmat Energy_full::dTi(const TubeVertex& v) const {
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    TRACE(0,"Energy_full::dTi()");
    dmat dTi=v.zero;
  ...
  dmat Energy_full::dTim1(const TubeVertex& v) const {
    TRACE(0,"Energy_full::dTim1()");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
    dmat dTim1=v.zero;
  ...
  vd Energy_full::kappaL(const TubeVertex& v)  const {
    TRACE(0,"Energy_full::kappaL(v)");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
  ...
  vd Energy_full::kappaR(const TubeVertex& v)  const {		// Returns thermal conductivity time domain data
    TRACE(0,"Energy_full::kappaR(v)");
    const dmat& DDTfd=v.gc->DDTfd;
    const dmat& fDFT=v.gc->fDFT;
    const dmat& iDFT=v.gc->iDFT;      
  ...
  d Energy_full::gamma(const TubeVertex& v) const {
    // d T0=v.T(0);
    d T0=v.gc->T0; 
